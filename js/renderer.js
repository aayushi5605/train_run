/**
 * renderer.js - WebGL Rendering Module
 * Handles all WebGL rendering operations including scene clearing and drawing
 * Manages the rendering pipeline for game objects
 */

function clearScene(gl, translate) {

  gl.clearColor(0.25, 0.60, 0.95, 1.0); // Brighter, more vibrant blue sky
